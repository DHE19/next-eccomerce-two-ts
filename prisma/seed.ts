import { randBetweenDate, randNumber, randProduct, randProductAdjective } from "@ngneat/falso";
...
const main = async () => {
    try {
        await prisma.category.deleteMany(); // delete all the categories
        await prisma.product.deleteMany(); // delete all the products
        //we created one thousand fake products
